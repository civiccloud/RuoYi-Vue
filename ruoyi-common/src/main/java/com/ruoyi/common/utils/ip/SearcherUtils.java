...
public class SearcherUtils {
    ...
    public static SearcherUtils newWithFileOnly(String dbPath) throws IOException {
        return new SearcherUtils(dbPath, null, null);
    }

    public static SearcherUtils newWithVectorIndex(String dbPath, byte[] vectorIndex) throws IOException {
        return new SearcherUtils(dbPath, vectorIndex, null);
    }

    public static SearcherUtils newWithBuffer(byte[] cBuff) throws IOException {
        return new SearcherUtils(null, null, cBuff);
    }

    // --- End of creator

    public SearcherUtils(String dbFile, byte[] vectorIndex, byte[] cBuff) throws IOException {
        if (cBuff != null) {
            this.handle = null;
    ...
    public static Header loadHeader(RandomAccessFile handle) throws IOException {
        ...
        handle.read(buff);
        return new Header(Arrays.toString(buff));
    }
